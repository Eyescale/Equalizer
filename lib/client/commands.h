...
namespace eq
{
    enum ServerCommand
    {
        ...
        REQ_SERVER_CHOOSE_CONFIG_REPLY,
        CMD_SERVER_CREATE_CONFIG,
        REQ_SERVER_CREATE_CONFIG,
        CMD_SERVER_CREATE_CONFIG_REPLY,
        CMD_SERVER_DESTROY_CONFIG,
        REQ_SERVER_DESTROY_CONFIG,
    ...
    enum NodeCommand
    {
        ...
        REQ_NODE_CREATE_PIPE,
        CMD_NODE_DESTROY_PIPE,
        REQ_NODE_DESTROY_PIPE,
    ...
    enum WindowCommand
    {
        ...
        REQ_WINDOW_CREATE_CHANNEL,
        CMD_WINDOW_DESTROY_CHANNEL,
        REQ_WINDOW_DESTROY_CHANNEL,
        CMD_WINDOW_SET_PVP,
        REQ_WINDOW_SET_PVP,
