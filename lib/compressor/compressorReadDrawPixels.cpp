...
REGISTER_TRANSFER( RGBA16F, RGB, 3, .5, .375, 1., true );
REGISTER_TRANSFER( RGBA16F, BGR, 3, .5, .375, 1.1, true );
...
REGISTER_TRANSFER( RGBA32F, RGB16F, 6, .5, .375, 1., true );
REGISTER_TRANSFER( RGBA32F, BGR16F, 6, .5, .375, 1.1, true );
REGISTER_TRANSFER( RGBA32F, RGBA, 4, .25, .25, 1., false );
REGISTER_TRANSFER( RGBA32F, BGRA, 4, .25, .25, 1.1, false );
REGISTER_TRANSFER( RGBA32F, RGB, 3, .25, .1875, 1., true );
REGISTER_TRANSFER( RGBA32F, BGR, 3, .25, .1875, 1.1, true );
