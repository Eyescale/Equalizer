...
void NodeFactory::releaseNode( Node* node ) { delete node; }
...
void NodeFactory::releaseSegment( Segment* segment ) { delete segment; }

Pipe* NodeFactory::createPipe( Node* parent ) { return new Pipe( parent ); }
void NodeFactory::releasePipe( Pipe* pipe ) { delete pipe; }
