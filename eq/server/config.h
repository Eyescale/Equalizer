...
public:
     ...
     */
    EQSERVER_API Channel* findChannel(const Segment* segment, const View* view);
    ...
    const co::Connections& getServerConnections() const { return _connections; }
    /**
...
private:
    ...
    template <class T>
    bool _postDelete(const uint128_t& id);
