...
public:
     ...
     */
    void setBuffers(const fabric::Frame::Buffer buffers) { _buffers = buffers; }
    ...
    /** Commit the frame */
    EQSERVER_API virtual uint128_t commit(
     ...
     */
    void setNativeOffset(const Vector2i& offset) { _native.setOffset(offset); }
