...
/* Copyright (c) 2006-2019, Stefan Eilemann <eile@equalizergraphics.com>
...
void Global::_readEnvironment()
{
    ...
    for (uint32_t i = 0; i < Config::FATTR_LAST; ++i)
    {
        const std::string& name =
            Config::getFAttributeString((Config::FAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Config::getIAttributeString((Config::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Node::getSAttributeString((Node::SAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Node::getCAttributeString((Node::CAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Node::getIAttributeString((Node::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Pipe::getIAttributeString((Pipe::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Window::getIAttributeString((WindowSettings::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Channel::getIAttributeString((Channel::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Channel::getSAttributeString((Channel::SAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            Compound::getIAttributeString((Compound::IAttribute)i);
        const char* envValue = getenv(name.c_str());
    ...
    {
        const std::string& name =
            View::getSAttributeString((View::SAttribute)i);
        const char* envValue = getenv(name.c_str());
...
std::ostream& operator<<(std::ostream& os, const Global* global)
{
    ...
    os << lunchbox::disableFlush << lunchbox::disableHeader << "#Equalizer "
       << global->getConfigFAttribute(Config::FATTR_VERSION) << " ascii"
       << std::endl
       << std::endl
       << "global" << std::endl
       << '{' << lunchbox::indent << std::endl;
    ...
    for (uint32_t i = 0; i < Config::FATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Config::getFAttributeString(static_cast<Config::FAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << value << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Config::IATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Config::getIAttributeString(static_cast<Config::IAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
    ...
    for (uint32_t i = 0; i < Node::SATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Node::getSAttributeString(static_cast<Node::SAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << "\"" << value << "\"" << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Node::CATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Node::getCAttributeString(static_cast<Node::CAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << "'" << value << "'" << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Node::IATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Node::getIAttributeString(static_cast<Node::IAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << static_cast<fabric::IAttribute>(value) << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Pipe::IATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Pipe::getIAttributeString(static_cast<Pipe::IAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << static_cast<fabric::IAttribute>(value) << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Channel::IATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Channel::getIAttributeString(static_cast<Channel::IAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << static_cast<fabric::IAttribute>(value) << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Channel::SATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Channel::getSAttributeString(static_cast<Channel::SAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << "\"" << value << "\"" << std::endl;
    }
    ...
    for (uint32_t i = 0; i < Compound::IATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            Compound::getIAttributeString(static_cast<Compound::IAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ');
    ...
    for (uint32_t i = 0; i < View::SATTR_ALL; ++i)
    {
        ...
        const std::string& name =
            View::getSAttributeString(static_cast<View::SAttribute>(i));
        os << name << std::string(GLOBAL_ATTR_LENGTH - name.length(), ' ')
           << "\"" << value << "\"" << std::endl;
    }
