...
static std::string _sAttributeStrings[ConnectionDescription::SATTR_ALL] = {
    MAKE_ATTR_STRING(SATTR_HOSTNAME), MAKE_ATTR_STRING(SATTR_PIPE_FILENAME),
    MAKE_ATTR_STRING(SATTR_FILL1), MAKE_ATTR_STRING(SATTR_FILL2)};
static std::string _iAttributeStrings[ConnectionDescription::IATTR_ALL] = {
    MAKE_ATTR_STRING(IATTR_TYPE), MAKE_ATTR_STRING(IATTR_TCPIP_PORT),
    MAKE_ATTR_STRING(IATTR_BANDWIDTH), MAKE_ATTR_STRING(IATTR_FILL1),
