...
#include <string>
static const std::string yuv420readback_glsl =
    ...
    "= vec4(-0.147 ,-0.289 , 0.436 , 0.0 );\n vec4 vMul = vec4( "
    "0.4996,-0.4184,-0.0812, 0.0 );\n /*vec4 vMul = vec4( "
    "0.2896,-0.2084,-0.0802, 0.0 );*/\n \n vec4 test = vec4( 1.0, 1.0, 1.0, "
    "0.0 );\n \n void main(void)\n {\n     vec2 pos = gl_FragCoord.xy - vec2( "
    "0.5, 0.5 );\n     pos.x = pos.x * 2.0;\n \n     float odd = fract( "
    "pos.y*0.5 );\n     float hor;\n     if( odd < 0.5 )\n         hor =  "
    "1.0;\n     else\n         hor = -1.0;\n \n     vec4 p1 = texture2DRect( "
