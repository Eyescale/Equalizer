...
public:
    ...
    {
        /** <a
           href="http://www.equalizergraphics.com/documents/design/threads.html#sync">Threading
           model</a> */
        IATTR_THREAD_MODEL,
...
protected:
    ...
    enum DirtyBits
    {
        ...
        DIRTY_NODE_BITS =
            DIRTY_ATTRIBUTES | DIRTY_PIPES | DIRTY_MEMBER | DIRTY_OBJECT_BITS
    };

    /** @internal @return the bits to be re-committed by the master. */
    virtual uint64_t getRedistributableBits() const { return DIRTY_NODE_BITS; }
private:
    /** Pipe children. */
    Pipes _pipes;
