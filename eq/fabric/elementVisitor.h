...
// visit methods hide visit methods of base visitor 'C'
...
public:
    ...
    virtual VisitorResult visitPre(const T*) { return TRAVERSE_CONTINUE; }
    /** Visit an element on a const up traversal. */
    virtual VisitorResult visitPost(const T*) { return TRAVERSE_CONTINUE; }
};
}
}
