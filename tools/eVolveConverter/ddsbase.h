...
void writePNMimage(const char *filename, unsigned const char *image,
                   ...
                   unsigned int components, int dds = 0);
...
void writePVMvolume(const char *filename, unsigned const char *volume,
                    ...
                    unsigned int components = 1, float scalex = 1.0f,
...
unsigned char *readPVMvolume(
    const char *filename, unsigned int *width, unsigned int *height,
    unsigned int *depth, unsigned int *components = NULL, float *scalex = NULL,
    float *scaley = NULL, float *scalez = NULL,
    unsigned char **description = NULL, unsigned char **courtesy = NULL,
...
unsigned char *quantize(unsigned char *volume, unsigned int width,
                        ...
                        BOOLINT nofree = FALSE, BOOLINT linear = FALSE,
