...
{
    FrustumData data;
    const Wall wall(Vector3f(-.8f, -.5f, -1.f), Vector3f(.8f, -.5f, -1.f),
                    Vector3f(-.8f, .5f, -1.f));
    data.applyWall(wall);
    ...
    const Wall left(Vector3f(-1, -1, 1), Vector3f(-1, -1, -1),
                    Vector3f(-1, 1, 1));
    data.applyWall(left);
