...
if(Qt5Gui_name)
  list(APPEND FIND_PACKAGES_DEFINES EQUALIZER_USE_QT5GUI)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND EQUALIZER_DEPENDENT_LIBRARIES Qt5Gui)
  endif()
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} Qt5Gui")
  link_directories(${${Qt5Gui_name}_LIBRARY_DIRS})
  if(NOT "${${Qt5Gui_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${Qt5Gui_name}_INCLUDE_DIRS})
  endif()
  if(NOT "${${Qt5Gui_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${Qt5Gui_name}_INCLUDE_DIR})
  endif()
endif()
...
set(EQUALIZER_DEPENDS vmmlib;Lunchbox;Collage;OpenGL;Boost;Pression;X11;hwsd;GLStats;hwloc;OpenSceneGraph;OpenCV;VRPN;Deflect;MAGELLAN;GLEW_MX;Qt5Core;Qt5Gui;Qt5Widgets)
