...
if(PKG_CONFIG_EXECUTABLE)
  find_package(vmmlib 1.6.1)
  if((NOT vmmlib_FOUND) AND (NOT VMMLIB_FOUND))
    pkg_check_modules(vmmlib vmmlib>=1.6.1)
  endif()
  if((NOT vmmlib_FOUND) AND (NOT VMMLIB_FOUND))
...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Collage 1.0.1)
  if((NOT Collage_FOUND) AND (NOT COLLAGE_FOUND))
    pkg_check_modules(Collage Collage>=1.0.1)
  endif()
  if((NOT Collage_FOUND) AND (NOT COLLAGE_FOUND))
    message(FATAL_ERROR "Could not find Collage")
  endif()
else()
  find_package(Collage 1.0.1  REQUIRED)
endif()
...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT hwsd_FOUND) AND (NOT HWSD_FOUND))
    pkg_check_modules(hwsd hwsd>=1.0.0)
  endif()
else()
  find_package(hwsd 1.0.0 )
endif()
...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT GLStats_FOUND) AND (NOT GLSTATS_FOUND))
    pkg_check_modules(GLStats GLStats>=0.1.0)
  endif()
else()
  find_package(GLStats 0.1.0 )
endif()
...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT SAGE_FOUND) AND (NOT SAGE_FOUND))
    pkg_check_modules(SAGE SAGE>=4.0)
  endif()
else()
  find_package(SAGE 4.0 )
endif()
...
if(SAGE_name)
  ...
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} SAGE")
...
set(EQUALIZER_BUILD_DEBS autoconf;automake;bison;cmake;doxygen;flex;git;git-review;git-svn;lcov;libavahi-compat-libdnssd-dev;libboost-date-time-dev;libboost-program-options-dev;libboost-regex-dev;libboost-serialization-dev;libboost-system-dev;libgl1-mesa-dev;libglewmx1.6-dev;libhwloc-dev;libibverbs-dev;libopencv-dev;libopenscenegraph-dev;libqt4-dev;librdmacm-dev;libspnav-dev;libudt-dev;libx11-dev;ninja-build;pkg-config;subversion)
