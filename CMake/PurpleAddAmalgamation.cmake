...
function(PURPLE_ADD_AMALGAMATION NAME SHORT_NAME VERSION ABI_VERSION)
  ...
  if(MSVC OR XCODE_VERSION)
    ...
    if(APPLE)
      set(THIS_DEFINITIONS EQ_DSO_NAME=\"${CMAKE_SHARED_LIBRARY_PREFIX}${NAME}.${ABI_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX}\")
    else()
      set(THIS_DEFINITIONS EQ_DSO_NAME=\"${CMAKE_SHARED_LIBRARY_PREFIX}${NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}.${ABI_VERSION}\")
    endif()
  endif()
  ...
  set_target_properties(${NAME} PROPERTIES
    ...
    VERSION ${VERSION} SOVERSION ${ABI_VERSION}
    FOLDER "Libraries"
    )
