...
function(PURPLE_ADD_AMALGAMATION NAME SHORT_NAME VERSION API_VERSION)
  ...
  if(MSVC OR XCODE_VERSION)
    ...
    if(APPLE)
      set(THIS_DEFINITIONS EQ_DSO_NAME=\"${CMAKE_SHARED_LIBRARY_PREFIX}${NAME}.${API_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX}\")
    else()
      set(THIS_DEFINITIONS EQ_DSO_NAME=\"${CMAKE_SHARED_LIBRARY_PREFIX}${NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}.${API_VERSION}\")
    endif()
  endif()
